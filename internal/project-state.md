...
- full web integration test base with Testcontainers-backed application context
...
Full web integration verification:
    random-port Spring Boot web runtime with Testcontainers-backed application context
```
